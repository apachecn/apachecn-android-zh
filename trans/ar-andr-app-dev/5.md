...
![Choosing physical objects](graphics/8553_05_01_FINAL.jpg)
...
![Understanding frame markers](graphics/8553_05_02.jpg)
...
![Understanding natural feature tracking targets](graphics/8553_05_03.jpg)

许多特征点可以在纹理清晰的图像上找到(例如本章中使用的街道图像):

![Understanding natural feature tracking targets](graphics/8553_05_04.jpg)
...
![VuforiaTM architecture](graphics/8553_05_05.jpg)
...
![Configuring VuforiaTM to recognize objects](graphics/8553_05_07.jpg)

让我们创建第一个数据库。点击**创建数据库**，进入`VuforiaJME`。您的数据库应该出现在您的**设备数据库**列表中。选择它以进入以下页面:

![Configuring VuforiaTM to recognize objects](graphics/8553_05_08.jpg)

点击**添加新目标**创建第一个目标。将出现一个对话框，需要填写不同的文本字段，如下图所示:

![Configuring VuforiaTM to recognize objects](graphics/8553_05_09.jpg)
...
![Configuring VuforiaTM to recognize objects](graphics/8553_05_10.jpg)
...
![Configuring VuforiaTM to recognize objects](graphics/8853_05_11.jpg)
...
![The Java integration](graphics/8553_05_12.jpg)
