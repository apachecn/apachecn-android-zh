...
7.  右键点击Android Studio的`app`文件夹。从弹出菜单中，导航至**新建** | **安卓资源目录**。
...
让我们通过给游戏增加一些图形来让敌人更有趣一点。首先，我们需要向项目中添加额外的图形。将下载包的`Chapter4/drawables`文件夹中的`enemy2.png`和`enemy3.png`复制粘贴到Android Studio的`drawables`文件夹中。
