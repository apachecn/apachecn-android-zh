...
现在，我们可以将这三个适当命名的图形添加到可绘制文件夹中，并开始将其添加到我们的`LevelCave`设计中。将下载包中的`Chapter7/drawables`文件夹中的`clip.png`、`coin.png`和`life.png`复制到你的Android Studio项目的`drawable`文件夹中。
