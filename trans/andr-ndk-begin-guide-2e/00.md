...
你是一个需要更多性能的 Android Java 程序员吗？你是一个不想为 Java 的复杂性及其失控的垃圾收集器而烦恼的 C/C++开发人员吗？您想创建快速、密集的多媒体应用程序或游戏吗？如果你对这些问题中的任何一个都回答是，那么这本书就是给你的。有了一些 C/C++开发的一般知识，您将能够首先进入原生安卓开发。
