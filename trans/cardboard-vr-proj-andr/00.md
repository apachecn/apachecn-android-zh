...
在整本书中，我们使用 Android Studio IDE 开发环境来编写和构建 Android 应用。你可以免费下载Android Studio，详见[第二章](02.html "Chapter 2. The Skeleton Cardboard Project")、*框架纸板项目*。你需要一部安卓手机来运行和测试你的项目。强烈建议您使用谷歌纸板浏览器在立体虚拟现实中体验您的应用。
