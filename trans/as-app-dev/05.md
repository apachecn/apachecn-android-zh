...
在创建安卓应用时，我们必须意识到多种屏幕尺寸和屏幕分辨率的存在。检查我们的布局如何在不同的屏幕配置中显示是很重要的。为了实现这一点，Android Studio提供了一个功能，当我们在设计模式下改变布局预览。
...
在下一章中，我们将了解谷歌 Play 可用的服务，以及如何使用Android Studio将它们集成到我们的项目中。我们将学习如何安装和集成谷歌技术提供的不同库，如谷歌地图、谷歌 Plus 等。