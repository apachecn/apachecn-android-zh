...
除了提供这种语言支持，安卓工作室还为各种外形的应用开发提供了便利。读者将已经熟悉安卓穿戴和安卓自动，最近集成开发环境已经包括了对安卓事物的支持。
...
C++ 不是每个人都喜欢的，更详细的内容超出了本书的范围。从安卓工作室的角度来看，那些想进一步利用 NDK 的人会发现，CMake 与 Gradle 无缝集成的方式使得测试和构建调用本地库的应用成为一种非常节省时间的方式。
