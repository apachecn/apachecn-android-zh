...
对于这个食谱，你只需要启动并运行Android Studio。
...
![Image capturing using the Camera2 API](graphics/B04299_06_01.jpg)
...
1.  在Android Studio，从启动向导中选择**导入安卓代码样本**，或者在**文件**菜单中选择**导入样本**。
...
4.  Android Studio会为你从 GitHub 获取样本项目。你也可以在[https://github.com/googlesamples/android-Camera2Basic](https://github.com/googlesamples/android-Camera2Basic)找到。
