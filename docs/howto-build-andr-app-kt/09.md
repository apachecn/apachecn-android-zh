...
![Figure 9.1: Testing pyramid ](image/B15216_09_01.jpg)
...
![Figure 9.2: Test output in Android Studio ](image/B15216_09_02.jpg)
...
![Figure 9.3: Test coverage in Android Studio ](image/B15216_09_03.jpg)
...
![Figure 9.4: Gradle commands in Android Studio ](image/B15216_09_04.jpg)
...
```是 Kotlin 中出现的转义字符，不应与引号混淆。它允许开发人员给方法起任何他们想要的名字，包括特殊字符或保留字。
...
如您所见，```字符已经消失，我们对`Context`对象的模拟初始化已经简化。我们可以对`SpecificConcatenatorTest`类应用同样的东西(为了简洁起见，已经删除了导入语句):
...
![Figure 9.5: Output of Exercise 9.01 ](image/B15216_09_05.jpg)
...
15.  Create a test for `MainActivity` and place it in the `test` directory. It will contain two test methods, one for success and one for error:
    ...
    ![Figure 9.6: Result of executing the tests in the test folder for Exercise 9.02 ](image/B15216_09_06.jpg)
...
![Figure 9.7: Result of executing the tests in the androidTest folder for Exercise 9.02 ](image/B15216_09_07.jpg)
...
![Figure 9.8: Output of Exercise 9.03 ](image/B15216_09_08.jpg)
...
![Figure 9.9: TDD cycle ](image/B15216_09_09.jpg)
...
4.  If we run the tests for the `AdderTest` class, we will see an output similar to the following figure, meaning that all our tests failed:
    ...
    ![Figure 9.10: Initial test status for Exercise 9.04 ](image/B15216_09_10.jpg)
...
6.  If we run the tests now, you will see that one will pass and the other will fail, similar to the following figure:
    ...
    ![Figure 9.11: Test status after resolving the success scenario for Exercise 9.04 ](image/B15216_09_11.jpg)
...
9.  If we run the tests now, we should see them all passing, similar to the following figure:
    ...
    ![Figure 9.12: Passing tests for Exercise 9.04 ](image/B15216_09_12.jpg)
