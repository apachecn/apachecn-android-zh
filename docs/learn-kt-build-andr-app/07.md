...
*   **申请名称** : `LocationAlarm`。
*   **公司域名**:AndroidStudio使用域名为我们开发的应用生成包名。该软件包确保我们的应用程序在游戏商店中获得唯一的标识符。一般来说，包名会是域名的反义词，比如这种情况下会是`com.natarajan.locationalarm`。
...
AndroidStudio通过在最常用的活动上提供现成的模板，让开发人员更容易包含他们的应用程序所需的活动类型。
