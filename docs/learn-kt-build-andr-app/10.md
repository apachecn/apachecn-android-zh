...
让我们从在AndroidStudio创建一个名为 TodoList 的新项目开始。在“向移动设备添加活动”屏幕上选择“不添加活动”:

![](img/d7dc52e6-5c32-4406-b43f-95c3eae36b1b.png)

项目创建完成后，通过选择文件|新建|Kotlin活动来创建Kotlin活动，如下图所示:
...
AndroidStudio提供了一个布局编辑器，通过将小部件拖动到可视化编辑器中，您可以构建自己的布局。这将自动为您的用户界面生成 XML 代码。
