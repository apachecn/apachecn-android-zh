...
创建一个名为 FunyFace 的新项目。打开应用程序模块的`build.gradle`文件，并更新依赖项，以包括移动视觉应用程序接口:
...
![](assets/2112ecc1-219a-482e-8a9d-c2cc06eeedfb.jpg)
...
一切就绪。运行应用程序，按下“检测面部”按钮，然后等待一会儿...：

![](assets/784e912e-461c-42b5-b1d6-a0ac18c096e2.png)

该应用程序应该能够检测到人脸，并且人脸周围应该会出现一个方框，瞧！

![](assets/71235c88-1ca6-4ac3-b85b-9c3b4488cb53.png)
...
![](assets/b183ac20-c006-4bcb-9066-28510bfaed67.png)
