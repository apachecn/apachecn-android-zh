...
下面的代码假设我们已经有一个名为`mySwitch`的对象，它是对布局中一个`Switch`对象的引用。我们可以显示和隐藏一个`TextView`小部件，就像我们在[第 12 章](14.html "Chapter 12. Connecting Our Kotlin to the UI and Nullability")中的*Kotlin会议界面*应用一样。
