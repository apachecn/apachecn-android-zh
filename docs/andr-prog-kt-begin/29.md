...
![What is a database?](Images/B12806_27_01.jpg)
...
![Inserting data into the database](Images/B12806_27_02.jpg)
...
在某些情况下，我们可以将`Cursor`绑定到用户界面的一部分(如`RecyclerView`，就像我们在*自我注释*应用程序中对`ArrayList`所做的那样，只需将一切留给安卓应用编程接口。
...
![Running the Age Database app](Images/B12806_27_03.jpg)

然后，我通过查看**结果**选项确认它在那里:

![Running the Age Database app](Images/B12806_27_04.jpg)

然后，我使用**删除**菜单选项，并再次查看**结果**选项，以检查我选择的名称是否已被删除:

![Running the Age Database app](Images/B12806_27_05.jpg)

接下来，我搜索了一个我知道存在的名字来测试**搜索**功能:

![Running the Age Database app](Images/B12806_27_06.jpg)
