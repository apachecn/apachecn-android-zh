...
我们已经看到了AndroidStudio的用户界面设计器，以及更多的Kotlin。在这一实践章节中，我们将构建另外三个布局——仍然非常简单，但比我们目前所做的工作更进一步。
...
我们还将编写一些Kotlin代码，在一个应用/项目中的不同布局之间切换。这是第一个将多个主题链接到一个整洁的包中的主要应用。这个应用叫做探索布局。
