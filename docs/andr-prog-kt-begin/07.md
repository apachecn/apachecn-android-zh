...
![Sizing fonts using sp](Images/B12806_05_21.jpg)
...
![Determining size with wrap or match](Images/B12806_05_22.jpg)
...
![Using padding and margin](Images/B12806_05_23.jpg)
...
![Using the layout_weight property](Images/B12806_05_24.jpg)
...
![Using gravity](Images/B12806_05_26.jpg)
...
![Using gravity](Images/B12806_05_25.jpg)
...
![Building a UI with CardView and ScrollView](Images/B12806_05_03.jpg)
...
您现在应该可以在`drawable`文件夹中看到您的图像，以及项目创建时安卓工作室放在那里的其他几个文件，如下图所示:

![Adding image resources](Images/B12806_05_04.jpg)
...
5.  This is how your layout should now appear:
    ...
    ![Creating the content for the cards](Images/B12806_05_05.jpg)
...
![Creating the content for the cards](Images/B12806_05_08.jpg)
...
14.  At this point, your layout will look very similar to the following screenshot:
    ...
    ![Creating the content for the cards](Images/B12806_05_06.jpg)
...
![Adding CardView to our layout](Images/B12806_05_07.jpg)
...
![Adding CardView to our layout](Images/B12806_05_09.jpg)

点击**确定**按钮，安卓工作室会在幕后做一些工作，为项目添加必要的部分。安卓工作室在这个项目中增加了更多的类，特别是为旧版本的安卓提供`CardView`功能的类，否则这些类不会有这些功能。
...
![Including layout files inside another layout](Images/B12806_05_10.jpg)
...
![Including layout files inside another layout](Images/B12806_05_11.jpg)
...
![Using the Android Studio theme designer](Images/B12806_05_12.jpg)

如前所述，创建自己的主题最简单的方法是从现有的主题开始，然后进行编辑。在**主题**下拉列表中，选择一个你喜欢的主题。我选择了**AppCompat**T5【黑暗】T6:

![Using the Android Studio theme designer](Images/B12806_05_13.jpg)

选择右侧要更改颜色的任何项目，并在屏幕中选择以下颜色:

![Using the Android Studio theme designer](Images/B12806_05_14.jpg)

系统会提示您为新主题选择一个名称。我称我的为`Theme.AppCompat.MyDarkTheme`:

![Using the Android Studio theme designer](Images/B12806_05_15.jpg)

现在，点击**修复**文本，将你的主题应用到当前应用，如下图所示:

![Using the Android Studio theme designer](Images/B12806_05_16.jpg)

然后，您可以在模拟器上运行您的应用程序来查看正在运行的主题:

![Using the Android Studio theme designer](Images/B12806_05_17.jpg)
...
![Creating a tablet emulator](Images/B12806_05_18.jpg)
...
![Creating a tablet emulator](Images/B12806_05_19.jpg)

准备好之后点击**完成**按钮。

现在，无论何时你运行安卓工作室的某个应用，你都可以选择**像素 C** (或者你创建的任何平板电脑)。这是我运行`CardView`应用的 Pixel C 模拟器截图:

![Creating a tablet emulator](Images/B12806_05_20.jpg)
