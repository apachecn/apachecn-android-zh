...
![How to use RecyclerView and RecyclerAdapter](Images/B12806_16_01.jpg)
...
2.  Look at the next screenshot to see what we are trying to achieve with the remaining steps of this section. I have annotated it to show what each part will be in the finished app:
    ...
    ![Creating a list item for RecyclerView](Images/B12806_16_02.jpg)
...
![Coding the RecyclerAdapter class](Images/B12806_16_03.jpg)
...
![Coding the RecyclerAdapter class](Images/B12806_16_05.jpg)
...
![Coding the RecyclerAdapter class](Images/B12806_16_06.jpg)
...
![Coding the RecyclerAdapter class](Images/B12806_16_10.jpg)
...
![Running the app](Images/B12806_16_07.jpg)

当你输入了几个类型的几个音符后，列表(`RecyclerView`)将会如下图所示:

![Running the app](Images/B12806_16_08.jpg)

并且，如果你点击查看其中一个笔记，它会是这样的:

![Running the app](Images/B12806_16_09.jpg)
