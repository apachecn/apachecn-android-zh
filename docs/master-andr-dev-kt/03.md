...
![](Images/4a326c99-c11c-47a3-8633-6e16ed711c6b.png)

如您所见，模型呈现了一个相对简单的应用程序，只有几个屏幕。这些屏幕将包含不同的组件，我们将在每个屏幕中解释这些组件。让我们看一下模型。
...
![](Images/5ff9331e-6609-466a-9375-7fbeb062a8af.png)
...
![](Images/f065d15d-1b8e-4818-a721-f6a7c5532f48.png)
...
![](Images/d658d3db-bfe9-469b-a79a-d1736ce31949.png)
...
运行您的应用程序，并尝试左右滑动。当您滑动时，观察日志和生命周期日志。
...
![](Images/26f2bac6-99df-4c27-9afa-f482bdfd75d1.png)
...
2.  为应用程序的活动定义`Intent`。(关于意图的更多信息，将在下一章中讨论):
