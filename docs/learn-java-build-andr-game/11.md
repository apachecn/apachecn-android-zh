...
![Figure 11.1 – Detecting rectangle collisions ](image/Figure_11.01_B16774.jpg)
...
![Figure 11.2 – Example of radius overlapping ](image/Figure_11.02_B16774.jpg)
...
![Figure 11.3 – Crossing number algorithm ](image/Figure_11.03_B16774.jpg)
...
![Figure 11.4 – Neighbor checking method example ](image/Figure_11.04_B16774.jpg)
...
![Figure 11.5 – Initialization of SoundPool ](image/Figure_11.05_B16774.jpg)
...
1.  Try out a few of these things to make cool sound effects. First, run `Bfxr`:
    ...
    ![Figure 11.6 – Running Bfxr ](image/Figure_11.06_B16774.jpg)
...
2.  Try out all the preset types that generate a random sound of that type. When you have a sound close to what you want, move to the next step:
    ...
    ![Figure 11.7 – Generating random sound ](image/Figure_11.07_B16774.jpg)

    图 11.7–产生随机声音

3.  Use the sliders to fine-tune the pitch, duration, and other aspects of your new sound:

    ![Figure 11.8 – Fine-tuning the pitch and duration of a sound ](image/Figure_11.08_B16774.jpg)
...
4.  Save your sound by clicking the **Export Wav** button. Despite the text of this button, as we will see, we can save in formats other than `.wav` too:
    ...
    ![Figure 11.9 – The Export Wav button ](image/Figure_11.09_B16774.jpg)
...
![Figure 11.10 – Viewing the assets folder ](image/Figure_11.10_B16774.jpg)
...
![Figure 11.11 – Playing the game ](image/Figure_11.11_B16774.jpg)
