...
![Figure 16.1 – RecyclerView widget ](image/Figure_16.01_B16773.jpg)
...
3.  Look at the next screenshot to see what we are trying to achieve with the remaining steps of this section. I have annotated it to show what each part will be in the finished app:
    ...
    ![Figure 16.2 – List item for use within our RecyclerView ](image/Figure_16.02_B16773.jpg)
...
![Figure 16.3 – Selecting Implement methods ](image/Figure_16.03_B16773.jpg)
...
![Figure 16.4 – Multiple errors in our code ](image/Figure_16.04_B16773.jpg)
...
![Figure 16.5 – Selecting Create class 'ListItemHolder' ](image/Figure_16.05_B16773.jpg)
...
![Figure 16.6 – Error with the class declaration ](image/Figure_16.06_B16773.jpg)
...
![Figure 16.7 – Adding a new note ](image/Figure_16.07_B16773.jpg)

图 16.7–添加新注释

当你输入了几个类型的几个音符后，列表(`RecyclerView`)会是这样的:

![Figure 16.8 – List of notes ](image/Figure_16.08_B16773.jpg)
