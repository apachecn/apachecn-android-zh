...
![Figure 10.1 – Declaring, initializing, and using an object of the class  ](image/Figure_10.1_B16773.jpg)
...
![Figure 10.2 – dot operator ](image/Figure_10.2_B16773.jpg)
...
![Figure 10.3 – Soldier object ](image/Figure_10.3_B16773.jpg)
...
现在我们可以运行我们的应用程序了。所有输出都将在 logcat 窗口中。
