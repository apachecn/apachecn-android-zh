...
你可能会想知道当我们有一个有很多变量要跟踪的应用程序时会发生什么。如果我们的 Note to Self 应用有 100 个笔记，或者在一个游戏中有 100 个最高分的高分表呢？我们可以像这样声明和初始化 100 个独立的变量:
...
运行示例应用程序，记住屏幕上不会发生任何事情，因为所有输出都将发送到我们在AndroidStudio的 logcat 控制台窗口。以下是输出:
