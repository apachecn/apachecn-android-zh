...
在我们进入下一个项目之前，实时绘图应用程序为我们提供了一个探索AndroidStudio另一个功能的绝佳机会。
...
代码优化超出了本书的范围，但是看看我们如何开始监控应用程序的性能是一个很好的介绍。从AndroidStudio主菜单中选择**查看**，然后选择**工具窗口** | **侧写**。

你会在AndroidStudio的下方看到如下窗口:

![Figure 22.6 – Android Studio window ](img/Figure_22.6_B16773.jpg)

图 22.6–AndroidStudio窗口
